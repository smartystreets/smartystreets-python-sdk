...
class Client:
    ...
    def build_request(self, lookup):
        ...
        request.parameters['html'] = str(lookup.html).lower()
        request.parameters['aggressive'] = str(lookup.aggressive).lower()
        request.parameters['addr_line_breaks'] = str(lookup.addresses_have_line_breaks).lower()
        request.parameters['addr_per_line'] = lookup.addresses_per_line
